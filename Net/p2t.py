...
# p2t_small-->PVTv2-B2
# p2t_base-->PVTv2-B3
# p2t_large-->PVTv2-B4/5
class Encoder_p2t_base(nn.Module):
    def __init__(self):
...
class Encoder_p2t_small(nn.Module):
    def __init__(self):
...
class Encoder_p2t_tiny(nn.Module):
    def __init__(self):
...
class Encoder_p2t_large(nn.Module):
    def __init__(self):
